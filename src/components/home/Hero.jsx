      ...
      <div id="home" className="bg-[url('/assets/images/background/hero_image.webp')] bg-cover bg-no-repeat">
        ...
        <div className="h-screen flex justify-center items-center container xl:max-w-[1140px] mx-auto xl:px-0 px-3">
          <div className="max-w-[727px] mx-auto">
            {/* Main heading */}
            <h1 className="font-anton max-w-[505px] leading-[1.2] mx-auto text-center text-white xl:text-4xl sm:text-[52px] text-[40px] font-normal" data-aos="fade-up" data-aos-delay="200">
              Exclusive Games. Pasión por ganar
            </h1>
            {/* Subheading */}
            <p className="text-white font-inter font-medium lg:text-base text-sm text-center lg:pt-4 pt-3 mb-0" data-aos="fade-up" data-aos-delay="600">
            ...
            {/* Button */}
            <div className="flex justify-center pt-10" data-aos="fade-up" data-aos-delay="800">
