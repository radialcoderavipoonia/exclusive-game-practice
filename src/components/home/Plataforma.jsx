...
const Plataforma = () => {
  return (
    <div className="container xl:max-w-[1043px] mx-auto xl:px-0 px-3 xl:py-[150px] lg:py-20 py-10">
      ...
      <div className="bg-[url('/assets/images/background/plataforma_image.webp')] sm:h-[308px] sm:py-0 py-12 flex justify-center items-center bg-99 w-full bg-center bg-no-repeat" data-aos="zoom-in">
