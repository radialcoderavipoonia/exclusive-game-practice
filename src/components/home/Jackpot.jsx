    ...
    <div className="container xl:max-w-[1140px] mx-auto xl:px-0 px-3 pt-14">
      <div className="flex md:flex-row flex-col justify-between items-center xl:gap-10 gap-6">
        ...
        <Image
          ...
          height={439}
          alt="jackpot images"
          className="xl:w-[557px] xl:h-[439px] lg:w-[450px] md:w-[350px] sm:h-[400px] lg:h-[400px] md:h-[350px]"
          data-aos="fade-right"
          data-aos-delay="100"
        />
        <div data-aos="fade-left" data-aos-delay="100">
          {/* Heading */}
          <h2 className="text-white font-anton  font-normal md:text-start text-center xl:text-3xl lg:text-[36px] text-[30px] leading-[100%]">
