...
import CommonButtonGradient from "../common/CustomButtonGradient"; // Importing CommonButtonGradient component
    ...
    >
      ...
      <div className="flex md:flex-row flex-col-reverse items-center md:gap-14 gap-8">
        ...
        <div className="max-w-[526px]" data-aos="fade-right">
          ...
          <p className="mb-0 lg:pt-4 pt-3 font-inter md:text-start text-center font-medium lg:text-base text-sm text-[#334349]">
        ...
        <Image
          ...
          data-aos="fade-left" // Image styles
        />
      </div>
    </div>
  );
