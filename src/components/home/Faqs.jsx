...
const Faqs = () => {
  ...
  return (
    <div className=" relative z-30" id="faq">
      <div className="absolute bg-circleGradient w-[284px] h-[284px] rounded-full blur-[208px] top-[-30%] start-[-10%] pointer-events-none xl:block hidden"></div>
      ...
      <div className="w-[484px] h-[484px] absolute bg-circleGradient opacity-50 rounded-full blur-[200px] xl:block hidden top-[-15%] left-[-20%]"></div>
    </div>
  );
};
