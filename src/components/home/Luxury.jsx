...
import { playingGames } from "../common/Helper";
...
const Luxury = () => {
  return (
    <div className="container xl:max-w-[1140px] mx-auto xl:px-0 px-3 py-4">
      <div className="lg:bg-[url('/assets/images/background/luxury_image.png')] bg-[#092423] lg:bg-dark-green rounded-2xl lg:border-0 border-[#839090] border-[1px] bg-center lg:bg-100 bg-contain bg-no-repeat">
