...
const Platinum = () => {
  return (
    <div className="container xl:max-w-[1140px] mx-auto xl:px-0 px-3 xl:py-12 py-6">
      ...
      <div className="lg:bg-[url('/assets/images/background/platinum_image.webp')] bg-[#092423] lg:bg-dark-green rounded-2xl lg:border-0 border-[#839090] border-[1px] bg-center lg:bg-100 bg-contain bg-no-repeat" data-aos="fade-up" data-aos-duration="800">
